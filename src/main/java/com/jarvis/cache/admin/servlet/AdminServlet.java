...
public class AdminServlet extends HttpServlet {
	...
	private void printList(HttpServletRequest req, HttpServletResponse resp, ICacheManager cacheManager, String cacheManagerName) throws IOException {
		...
		for (AutoLoadTO tmpTO : queue) {
			String className = tmpTO.getCacheClass();
			String methodName = tmpTO.getCacheMethod();
