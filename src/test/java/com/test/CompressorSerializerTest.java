...
public class CompressorSerializerTest {
    ...
    public static void main(String args[]) throws Exception {
        ...
        wrapper.setCacheObject(
            "1111asdfadsfasdfasdfasdffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff中茜轼阿斯达克苛阿卡斯斯柯达卡罗拉中中国国际中叫苦连天或或，巴彦县呀，四海无闲田工烟圈卡里考虑中喵来看，轼功用fffffffffasdfsadfasdf");
